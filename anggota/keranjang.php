...
<body>
    ...
    <form method="post">
        <table border="1">
            ...
            ?>
                <tr>
                    <td><a href="keranjang.php?index=<?php echo $index; ?>" onclick="return confirm('Kamu yakin untuk di hapus?')">Hapus</a></td>
    ...
    <br>
    <a href="index_anggota.php">Lanjut Belanja</a> | <a href="checkout.php">Checkout</a>
    <?php
